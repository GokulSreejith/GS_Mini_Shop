<!-- Base Layout -->
<?= $this->extend('users/layouts/base.php') ?>
...
<div class="w-full h-full bg-black dark:bg-gray-900 bg-opacity-90 top-0 overflow-y-auto overflow-x-hidden fixed sticky-0" id="chec-div">
    <div class="w-full absolute z-10 right-0 h-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700" id="checkout">
        <div class="flex items-end lg:flex-row flex-col justify-end" id="cart">
            <div class="lg:w-3/5 md:w-8/12 w-full lg:px-12 lg:py-14 md:px-6 px-4 md:py-8 py-4 bg-white dark:bg-gray-800 overflow-y-hidden overflow-x-hidden lg:h-screen h-auto" id="scroll">
                <div class="flex items-center text-gray-500 hover:text-gray-600 dark:text-white cursor-pointer" onclick="">
                ...
                <div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
                    ...
                    <div class="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                        ...
                        <div class="flex items-center justify-between w-full pt-1">
                            ...
                            <select aria-label="Select quantity" class="w-[67px] py-2 px-2.5 border border-gray-200 mr-6 focus:outline-none dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-white">
                                <option>01</option>
                                <option>02</option>
                                <option>03</option>
                            </select>
                        ...
                        <div class="flex items-center justify-between pt-5">
                            ...
                            <p class="text-base font-black leading-none text-gray-800 dark:text-white">2,000</p>
                        </div>
                    </div>
                </div>
                <div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
                ...
                <div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
                    ...
                    <div class="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                        ...
                        <div class="flex items-center justify-between pt-5">
                            ...
                            <p class="text-base font-black leading-none text-gray-800 dark:text-white">1,000</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="lg:w-2/5 md:w-8/12 w-full bg-gray-100 dark:bg-gray-900 h-full">
                <div class="flex flex-col lg:h-screen h-auto lg:px-8 md:px-7 px-4 lg:py-20 md:py-10 py-6 justify-between overflow-y-auto">
                    <div>
                        ...
                        <div class="flex items-center justify-between pt-16">
                            ...
                            <p class="text-base leading-none text-gray-800 dark:text-white">5,000</p>
                        </div>
                        <div class="flex items-center justify-between pt-5">
                            <p class="text-base leading-none text-gray-800 dark:text-white">Shipping</p>
                            <p class="text-base leading-none text-gray-800 dark:text-white">80</p>
                        </div>
                        <div class="flex items-center justify-between pt-5">
                            <p class="text-base leading-none text-gray-800 dark:text-white">Tax</p>
                            <p class="text-base leading-none text-gray-800 dark:text-white">60</p>
                        </div>
                    </div>
                    <div>
                        <div class="flex items-center pb-6 justify-between lg:pt-5 pt-20">
                            <p class="text-2xl leading-normal text-gray-800 dark:text-white">Total</p>
                            <p class="text-2xl font-bold leading-normal text-right text-gray-800 dark:text-white">5,140</p>
                        </div>
