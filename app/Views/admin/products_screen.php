<!-- Base With header and footer Layout -->
<?= $this->extend('admin/layouts/base_header_footer.php') ?>
    ...
    <div class=" flex items-center justify-between pb-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="lg:ml-40 ml-10 space-x-8">
                ...
                <button class="bg-indigo-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer">Add Product</button>
            </div>
        </div>
    </div>
    <div>
                ...
                <table class="min-w-full leading-normal">
                    <thead>
                        <tr>
                            ...
                            <th class="pr-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-middle text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                Action
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <p class="text-gray-900 whitespace-no-wrap">Shirt</p>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <p class="text-gray-900 whitespace-no-wrap">$400</p>
                            </td>
                            ...
                            <td class="flex justify-center items-center space-x-4">
                                <button class="bg-teal-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer">View</button>
                                <button class="bg-indigo-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer">Edit</button>
                                <button class="bg-amber-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer">Reject</button>
                        ...
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <p class="text-gray-900 whitespace-no-wrap">T Shirt</p>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        ...
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <p class="text-gray-900 whitespace-no-wrap">Pants</p>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <p class="text-gray-900 whitespace-no-wrap">$200</p>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <p class="text-gray-900 whitespace-no-wrap">
                                    64
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <span class="relative inline-block px-3 py-1 font-semibold text-orange-900 leading-tight">
                                    ...
                                    <span class="relative">Reported</span>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="px-5 py-5 bg-white text-sm">
                                <p class="text-gray-900 whitespace-no-wrap">Shorts</p>
                            </td>
                            <td class="px-5 py-5 bg-white text-sm">
                            ...
                            <td class="px-5 py-5 bg-white text-sm">
                                <span class="relative inline-block px-3 py-1 font-semibold text-amber-900 leading-tight">
                                    <span aria-hidden class="absolute inset-0 bg-amber-400 opacity-50 rounded-full"></span>
